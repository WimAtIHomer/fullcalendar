...
function RoomView(element, calendar, viewName) {
	var t = this;
	...
	function buildSkeleton() {
        ...
        slotDate = t.start.clone().time(minTime);
		...
		hoverListener.start(function(cell) {
			...
			if (cell) {
				...
				if (d1.hasTime()) {
					...
					renderDayOverlay(d1, d2, cell.col);
				}
			}
		}, ev);
	}
